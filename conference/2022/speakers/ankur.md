...
**Ankur Satle** is an **Architect** working on **Telecom products** at [EXFO](https://www.exfo.com/){:target="_blank"}. He has extensively worked on high-performance **VoIP, 3G/4G/5G/IMS protocols, Network Monitoring, OSS/BSS** monolith & distributed systems in his 19+ years of experience. He is currently working on building a Smart Data Platform with eBPF, DPDK, Cloud & Microservices Distributed systems for Service Assurance & Network Monitoring of 5G, 4G, 3G products. 
...
If you attended any CppIndia Tech-Talk, you will find him there hosting and sharing his thoughts. He is an active Organizer, Presenter and Maintainer at CppIndia. You can check out his talks from [Cppcon 2020](https://www.youtube.com/watch?v=5ji9iRq7JoE), [Cppcon 2021](https://www.youtube.com/watch?v=udUwDk5YW7Q) and CppIndia on [YouTube](https://www.youtube.com/results?search_query=ankur+satle). He is awaiting confirmation on his talk proposal for [Cppcon 2022](https://cppcon.org/) also. 
