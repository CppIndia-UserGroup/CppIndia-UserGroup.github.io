...
| 16:15 - 17:15 |  **How C++ eliminated Memory Issues** | [Ankur Satle](/conference/2022/speakers/ankur/) | Memory safety issues had been a big pain point with C++. But not anymore! Today, memory issues are a major concern for only about 14% of developers. We go through how C++ makes memory safety a non-issue. We discuss how to foolproof implementations against memory issues like memory leaks, dangling pointers, double delete/free, bounds safety, etc. Let's stop worrying about memory safety and focus on delivering _value_, shall we? |
| 17:15 - 17:30 |  **Closing** | | 
